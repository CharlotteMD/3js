...
function main() {
    ...
    const fov = 75; // the angle from the eye to the object (in degrees) (the smaller the number the bigger the cube/closer to the eye)
    ...
    function makeInstance(geometry, color, x) {
      ...
      const cubes = [
        ...
        makeInstance(geometry, 0x00bbff,  2),
      ];
